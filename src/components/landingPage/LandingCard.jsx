...
export default function LandingCard({ imageUrl, text }) {
  return (
    <div className="w-full min-w-[200px] h-[231px] md:w-[250px] md:h-[250px]  lg:w-[292px] lg:h-[201px] bg-[#E6ECE9] flex gap-2 items-center justify-center flex-col rounded-lg">
